...
const CANARIES = [
  { name: 'doc-structure', line: '- doc-structure (mechanical, ~free): broken links/anchors · heading hierarchy · duplicate sibling headings · table shape · orphan/undefined refs · bare URLs — run the AST engine the way its skill contract states (the skill ships it beside itself), never re-derive by eye.' },
